...
#	yum -y install binutils compat-libstdc++-33 compat-libstdc++-33.i686 ksh elfutils-libelf elfutils-libelf-devel glibc glibc-common glibc-devel gcc gcc-c++ libaio libaio.i686 libaio-devel libaio-devel.i686 libgcc libstdc++ libstdc++.i686 libstdc++-devel libstdc++-devel.i686 make sysstat unixODBC unixODBC-devel
	yum -y install binutils	compat-libcap1	compat-libstdc++-33	compat-libstdc++-33.i686	elfutils-libelf	elfutils-libelf-devel	gcc	gcc-c++	glibc	glibc-common	glibc-devel	glibc-devel.i686	glibc.i686	ksh	libaio	libaio-devel	libaio-devel.i686	libaio.i686	libgcc	glibc-devel.i686	libstdc++	libstdc++-devel	libstdc++-devel.i686	libstdc++.i686	libXi	libXi.i686	libXtst	libXtst.i686	make	sysstat	unixODBC	unixODBC-devel
	yum clean all
